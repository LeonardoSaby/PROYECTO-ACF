    ...
    <head>
        ...
        <style>
            * {
            ...
            .icon-infantes { color: #ff6b6b; }
            .icon-docentes { color: #4ecdc4; }
            .icon-asistencia { color: #ffe66d; }
            .icon-reportes { color: #95e1d3; }
            .icon-cursos { color: #c7b3ff; }
            .icon-tutores { color: #ff9a76; }
                ...
                <nav>
                    @auth
                        ...
                        <form action="{{ route('logout') }}" method="POST" style="display: inline;">
                            @csrf
                            <button type="submit" style="background: none; border: none; cursor: pointer; font-size: 1rem; font-weight: 600; color: #333; padding: 0.7rem 1.5rem;">
                                Salir
                            </button>
                        </form>
                    @else
